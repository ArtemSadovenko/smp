...
class Drawer:
    ...
    def save(self, plot: plt):
        plt.savefig("D:\програмування навчання\ІТ-32\Спеціалізовані Мови\projects\data\lab8\DIAG.png")
        plt.savefig("D:\програмування навчання\ІТ-32\Спеціалізовані Мови\projects\data\lab8\DIAG.svg")
        plt.savefig("\data\lab8\DIAG.pdf")
